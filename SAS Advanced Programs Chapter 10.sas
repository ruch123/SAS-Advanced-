...
%let crsnum=3;
data revenue;
set sasusers.all end=final; *http://support.sas.com/documentation/cdl/en/basess/58133/HTML/default/viewer.htm#a001322490.htm;
...
where course_code="&crsid";
var location begin_date teacher;
title1 "Schedule for &&crsid";* why dont we use && ,why&&&;
footnote; 
run;
%let crsid=C002;
proc print data=sasuser.schedule noobs label;
